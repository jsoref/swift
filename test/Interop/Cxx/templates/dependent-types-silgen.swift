...
// CHECK:   [[THUNK_REF:%.*]] = function_ref @$sSC27dependentReturnTypeInfferedyyps5Int64VF : $@convention(thin) (Int64) -> @out Any
...
// CHECK-LABEL: sil [transparent] [serialized] [ossa] @$sSC27dependentReturnTypeInfferedyyps5Int64VF : $@convention(thin) (Int64) -> @out Any
// CHECK: bb0(%0 : $*Any, %1 : $Int64):
// CHECK:   [[SPEC_OUT:%.*]] = alloc_stack $__CxxTemplateInst1MIxE

// CHECK:   [[FN:%.*]] = function_ref @{{_Z27dependentReturnTypeInfferedIxE1MIT_ES1_|\?\?\$dependentReturnTypeInffered@_J@@YA\?AU\?\$M@_J@@_J@Z}} : $@convention(c) (Int64) -> __CxxTemplateInst1MIxE
...
// CHECK-LABEL: end sil function '$sSC27dependentReturnTypeInfferedyyps5Int64VF'

public func test() -> Int64 {
  let m = dependentReturnTypeInffered(Int64(42)) as! M<Int64>
  return m.getValue()
}
...
// CHECK-LABEL: sil [serialized] [clang dependentReturnTypeInffered]  @{{_Z27dependentReturnTypeInfferedIxE1MIT_ES1_|\?\?\$dependentReturnTypeInffered@_J@@YA\?AU\?\$M@_J@@_J@Z}} : $@convention(c) (Int64) -> __CxxTemplateInst1MIxE
